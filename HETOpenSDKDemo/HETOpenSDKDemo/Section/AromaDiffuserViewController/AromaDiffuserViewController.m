...
- (void)actionbtnmist:(UIButton *)btn
{
    ...
    self.updateFlag=1<<test;
     NSString *updateFlagStr=[NSString stringWithFormat:@"%08x",self.updateFlag];//400000
    for(int j=0;j<3;j++)
    {
...
- (void)actionbtncolor:(ColorButton *)btn
{
    ...
    self.updateFlag=1<<(31-19-1);//00000800
     NSString *updateFlagStr=[NSString stringWithFormat:@"%08x",self.updateFlag];//00000800
